...
border-color:pink;
    ...
    <title> QUERIES /RESPONSES DATASET</title>
</head>
<body>
  <center>
    <form action="" method="post">
     ...
     <br> <br> <br> 
<a href="dds.php"><input type="button" id="invalid_btn" value=" BACK "style="color:#ffffff; padding: 12px 28px ; background-color:#e61010; border-radius: 10px; border: 2px solid white;"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
